...
#python3 train.py --n_inputs=7 --n_epoch=30 \
#                 --refresh_stats=True --mu_ranks=5 --load_mu_sigma=False \
#                 --datadir=$DATA_DIR --datatype="numpy" --stoch=False
#python3 train.py --n_inputs=7 --n_epoch=50 \
...
#python3 train.py --n_inputs=7 --n_epoch=20 \
#                 --refresh_stats=True --mu_ranks=5 --load_mu_sigma=False \
#                 --datadir=$DATA_DIR --datatype="numpy" --stoch=False
#python3 train.py --n_inputs=7 --n_epoch=20 \
#                 --refresh_stats=True --mu_ranks=5 --load_mu_sigma=True \
...
#python3 train.py --n_inputs=15 --n_epoch=100 \
#                 --refresh_stats=True --mu_ranks=7 --load_mu_sigma=False \
#                 --datadir=$DATA_DIR --datatype="numpy" --stoch=False
#python3 train.py --n_inputs=15 --n_epoch=150 \
...
#python3 train.py --n_inputs=15 --n_epoch=30 \
...
# Achieves 0.61. There is a room for improvement.

# mg data (1385, 6). This dataset is easy for standard methods.
# Initial Values [0.7, 0.2, 0.1]
#DATA_DIR=$DATASETS_DIR_1"Regression/mg(1385, 6).txt"
#python3 train.py --n_inputs=10 --n_epoch=300 \
#                 --refresh_stats=True --mu_ranks=5 --load_mu_sigma=False \
#                 --datadir="$DATA_DIR" --datatype="svmlight" --stoch=False
#python3 train.py --n_inputs=10 --n_epoch=50 \
#                 --refresh_stats=True --mu_ranks=5 --load_mu_sigma=True \
#                 --datadir="$DATA_DIR" --datatype="svmlight" --stoch=False
...
#python3 train.py --n_inputs=7 --n_epoch=15 \
#                 --refresh_stats=True --mu_ranks=7 --load_mu_sigma=False \
#                 --datadir=$DATA_DIR --datatype="numpy" --stoch=False
