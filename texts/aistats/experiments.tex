...
In this section we provide some numerical justification of using Tensor Train
format for the mean $\mu$ of the variational distribution.

\begin{itemize}
  \item Visualization of the $\mu$ for standard inducing input GP and TT-GP.
  \item Plot of quality of TT approximation against TT-rank.
\end{itemize}
