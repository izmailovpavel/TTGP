...
\begin{abstract}
  ...
  scales to large datasets and to higher input dimensionalities than prior work.
  We build on top of stochastic variational inference based on inducing inputs,
  kernel interpolation, and structure exploiting algebra.
  The key idea of the our method is to utilize
